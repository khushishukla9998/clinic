...
const getDoctors = async (req, res) => {
    try {
        ...
        return commonUtils.sendSuccessResponse(req, res, "Doctors retrieved successfully.", {
            doctors,
            pagination: {
                total,
                page: Number(page),
...
const getDoctorProfile = async (req, res) => {
    try {
        ...
        return commonUtils.sendSuccessResponse(req, res, "Doctor profile retrieved successfully.", profile);
    } catch (error) {
        return commonUtils.sendErrorResponse(req, res, error.message, null, 500);
    }
};
